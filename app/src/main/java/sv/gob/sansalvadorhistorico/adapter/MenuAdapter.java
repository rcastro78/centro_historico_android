...
public class MenuAdapter extends BaseAdapter {
    ...
    public MenuAdapter(Activity activity, ArrayList<MenuPrincipal> items) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.item_menu_principal, null);
            holder = new ViewHolder();
            //holder.lblMenu = convertView.findViewById(R.id.lblMenu);
            holder.imgMenu = convertView.findViewById(R.id.imgMenu);
            holder.rlMenu = convertView.findViewById(R.id.rlMenu);
